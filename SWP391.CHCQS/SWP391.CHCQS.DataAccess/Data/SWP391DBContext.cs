...
namespace SWP391.CHCQS.DataAccess.Data
{
    ...
    {      
        ...
        //                r => r.HasOne<Combo>().WithMany().HasForeignKey("QuotationId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__StandardQ__quota__66603565"),
        //                j =>
        //                {
        ...
        //                r => r.HasOne<Combo>().WithMany().HasForeignKey("QuotationId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__StandardQ__quota__6754599E"),
        //                j =>
        //                {
