...
namespace SWP391.CHCQS.DataAccess.Migrations
{
    ...
    [Migration("20240216101257_AddFullDataForAllTables")]
    partial class AddFullDataForAllTables
    {
            ...
            modelBuilder.Entity("SWP391.CHCQS.Model.CustomQuotation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "CQ001",
                            Acreage = "240m2",
                            Date = new DateTime(2024, 2, 16, 17, 12, 56, 534, DateTimeKind.Local).AddTicks(6523),
            ...
            modelBuilder.Entity("SWP391.CHCQS.Model.RequestForm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GenerateDate = new DateTime(2024, 2, 16, 17, 12, 56, 534, DateTimeKind.Local).AddTicks(6493),
                            Location = "Dĩ An, Bình Dương",
                            Status = true
                        });
                });
