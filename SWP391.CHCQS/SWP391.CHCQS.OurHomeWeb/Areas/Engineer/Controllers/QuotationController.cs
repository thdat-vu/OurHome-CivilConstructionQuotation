...
namespace SWP391.CHCQS.OurHomeWeb.Areas.Engineer.Controllers
{
    ...
    public class QuotationController : Controller
    {
        ...
        public async Task<IActionResult> Quote(string QuotationId)
        {
            ...
            if (taskCart.Count == 0)
            {
                taskCart = _unitOfWork.TaskDetail.GetTaskDetail(CustomQuotationSession.Id, includeProp: "Task").Select(x => new CustomQuotationTaskViewModel
                {
                    Task = x.Task,
        ...
        public async Task<IActionResult> SubmitQuote()
        {
            ...
            try
            {
                ...
                List<TaskDetail> customQuotaionTasks = taskCart.Select(t => new TaskDetail
                {
                    TaskId = t.Task.Id,
                ...
                _unitOfWork.TaskDetail.AddRange(customQuotaionTasks);
